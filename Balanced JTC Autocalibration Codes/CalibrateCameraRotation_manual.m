...
SLM1_dir = 'Z:\DCIM\';
SLM2_dir = 'Y:\DCIM\';
tImChange = 1; % Delay time [s] for copying over images
...
im2 = imrotate(im1, -angle1, 'bilinear', 'crop');
figure;
    imagesc(im2); axis image; set(gca, 'YDir', 'normal'); 
...
angle1 = getRotation(im1);
fprintf('SLM2 on que_cam: correction angle: %.4f°\n\n', angle1);
...
function angle_rot = getRotation(im)
